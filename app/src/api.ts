...
export type WalletProgram = Program & { balance: number; tiers: Record<string, TierInfo> };

export type Me = {
  user: { id: string; name: string; username: string | null; code: string };
